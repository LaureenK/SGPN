...
parser.add_argument('--input_list', type=str, default='SGPN/data/train_files.txt', help='Input data list file')
...
#Erstelle Ordnerstruktur für Output
...
#Funktion zum ausdrucken der daten
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        with tf.device('/gpu:' + str(FLAGS.gpu)):
            #batch: size of input files?
            #create batch variable
            batch = tf.Variable(0, trainable=False, name='batch')

            #Beim Trainieren eines Modells wird häufig empfohlen, die Lernrate im Laufe des Trainings zu verringern. 
            #Diese Funktion wendet eine exponentielle Abklingfunktion auf eine bereitgestellte anfängliche Lernrate an.
